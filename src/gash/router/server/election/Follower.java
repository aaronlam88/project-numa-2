...
public class Follower implements Runnable {
	...
	public void startElectionTimer() {
		...
		if (isFollower) {
			...
			try {
				...
				}, ThreadLocalRandom.current().nextInt(150, 300)); // start the
																	// process
																	// after
																	// this many
																	// ms, and
	...
	// TODO if appendEntry is received in the state of the follower then maks
	// the necessary setting and keep it in a follwoer stage

	// TODO dont process the write messagge if the sever is in the follower
	// state
}
